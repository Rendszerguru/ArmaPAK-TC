...
- **Smart Extract (Dependency handling):** 🧠
  Automatically analyzes `.xob` and `.emat` files during extraction to identify and extract all required dependencies (like textures), even if they are located in different loaded `.pak` archives.
